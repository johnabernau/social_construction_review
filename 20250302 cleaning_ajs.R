...
filter(df_meta, docSubType == "book-review") %>% View()
filter(df_meta, docSubType == "misc") %>% View()

df_meta <- filter(df_meta, docSubType %in% c("research-article"))
df_meta <- filter(df_meta, title != "Book Reviews")
...
# saving metadata
ajs_meta <- df_meta
save(ajs_meta, file = "~/Desktop/ajs_meta.RData")

# saving unigrams
ajs_uni <- df_uni
save(ajs_uni, file = "~/Desktop/ajs_uni.RData")

# save bigrams
ajs_bi <- df_bi
save(ajs_bi, file = "~/Desktop/ajs_bi.RData")

# save trigrams
# ajs_tri <- df_tri
# save(ajs_tri, file = "~/Desktop/ajs_tri.RData")
